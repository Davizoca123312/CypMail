...
if not os.path.exists(dll_path):
    ...
    print("Compile o código C com: gcc -shared -o bin/cypmail.dll src_c/*.c")
    exit(1)
...
c_lib.start_smtp_server.restype = ctypes.c_int

print("Iniciando o servidor SMTP...")

# Chame a função do servidor
# Esta função irá bloquear, então o script ficará em execução
exit_code = c_lib.start_smtp_server()
